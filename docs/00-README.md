# HR Core Lite 프로젝트 문서 패키지

이 문서 패키지는 **도메인 지식이 거의 없는 학생 3명**이  
**1~2주 안에 React + Spring Boot + AWS 배포**까지 진행할 수 있도록 만든 시작용 문서 세트입니다.

프로젝트 주제는 **사내 인사 · 근태 · 휴가 관리 HR 시스템(HR Core Lite)** 입니다.
...
> 급여는 HR 시스템에서 중요한 모듈이지만,  
> **1~2주 / 학생 3명 / 첫 프로젝트** 기준으로는 범위가 커지므로 이번 문서에서는 확장 포인트로 둡니다.
